...
const theme = (darkMode, color) => ({
  ...
  // uniswapPink: darkMode ? '#0BFD37' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#0BFD37',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#0BFD37',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#0BFD37',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #0BFD37 30 0%, #fff 0%)`
})
